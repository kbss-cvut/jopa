...
public class OutputFilesGenerator {
    ...
    public static File createClass(MetamodelClass glass) {
        ...
        glass.getImports().forEach((imp) -> sbOut.append("import ")
                                                 .append(imp)
                                                 .append(";\n"));
        if (!glass.getExtend().isEmpty()) {
            sbOut.append("import ")
    ...
    /**
     * Class which will generate all given MetamodelClass objects. It works with every method in OutputFilesGenerator
     * class.
     *
    ...
    public static void generateOutputFiles(Map<String, MetamodelClass> classes, String outputDirectory,
                                           Messager messager, boolean debugOption) {
