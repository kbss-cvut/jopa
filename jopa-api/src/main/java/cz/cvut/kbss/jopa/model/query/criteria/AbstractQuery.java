...
/**
 * The AbstractQuery interface defines functionality that is common to both
 * top-level queries and subqueries. It is not intended to be used directly in
 * query construction.
 * 
 * All queries must have:
 * 
 * a set of root entities (which may in turn own joins) All queries may have:
 * 
...
public interface AbstractQuery<T> {
	 ...
	 * the CriteriaQuery or Subquery itself, including any subquery roots
	 * defined as a result of correlation. Returns empty set if no roots have
	 * been defined. Modifications to the set do not affect the query.
	 * 
