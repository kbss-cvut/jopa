...
public enum Command {
    help(CommandParserProvider.getCommandHelp(), String.join(System.lineSeparator(),
    ...
    list(CommandParserProvider.getCommandList(), String
        .join(System.lineSeparator(), "Lists all available IC contexts.", "",
    ...
    vocabulary(CommandParserProvider.getCommandVocabulary(), String
        .join(System.lineSeparator(), "Generates vocabulary based on the ICs.", "",
