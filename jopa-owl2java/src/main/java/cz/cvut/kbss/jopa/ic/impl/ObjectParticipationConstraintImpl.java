...
class ObjectParticipationConstraintImpl extends AbstractParticipationConstraintImpl<OWLObjectProperty, OWLClass>
        implements ObjectParticipationConstraint {

    public ObjectParticipationConstraintImpl(OWLClass subject, OWLObjectProperty predicate, OWLClass object, int min,
                                             int max) {
