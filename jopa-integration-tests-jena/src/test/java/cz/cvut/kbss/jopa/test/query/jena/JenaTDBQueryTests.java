...
public class JenaTDBQueryTests {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(JenaTDBQueryTests.class);
    ...
    public static void setUpBeforeClass() throws Exception {
        em = TestEnvironment.getPersistenceConnector("JenaTDB_SPARQLQueryTests", storage, false, properties);
