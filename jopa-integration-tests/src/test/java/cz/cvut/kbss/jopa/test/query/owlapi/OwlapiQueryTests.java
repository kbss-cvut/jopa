...
public class OwlapiQueryTests {

	private static final Logger LOG = Logger.getLogger(OwlapiQueryTests.class.getName());
	...
	public static void setUpBeforeClass() throws Exception {
		em = TestEnvironment.getPersistenceConnector("OwlapiSPARQLQueryTests", storage, false,
				properties);
