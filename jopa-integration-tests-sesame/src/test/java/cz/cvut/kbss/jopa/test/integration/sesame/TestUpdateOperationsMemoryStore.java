...
public class TestUpdateOperationsMemoryStore {
    ...
    public void testMergeSet() throws Exception {
        em = TestEnvironment.getPersistenceConnector("SesameMergeSet", storage, false, properties);
    ...
    public void testMergeDetachedWithObjectPropertyChange() {
        em = TestEnvironment.getPersistenceConnector("SesameUpdateDetachedWithOPChange", storage, true,
                properties);
    ...
    public void testModifyAttributesOfBasicTypes() {
        em = TestEnvironment.getPersistenceConnector("SesameModifyBasicTypeAttributes", storage,
                false, properties);
    ...
    public void testModifyEnumAttribute() {
        em = TestEnvironment.getPersistenceConnector("SesameModifyEnumAttribute", storage, false, properties);
