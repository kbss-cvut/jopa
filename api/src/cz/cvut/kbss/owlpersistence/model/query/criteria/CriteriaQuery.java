...
public interface CriteriaQuery<T> extends AbstractQuery<T> {
	 ...
	 * the query result type is specified. For example:
	 * 
	 * CriteriaQuery<String> q = cb.createQuery(String.class); Root<Order> order
	 * = q.from(Order.class);
	 ...
	 * the arguments to the multiselect method. An argument to the multiselect
	 * method must not be a tuple- or array-valued compound selection item.
	 * 
	 * The semantics of this method are as follows:
	 * 
	 * If the type of the criteria query is CriteriaQuery<Tuple> (i.e., a
	 * criteria query object created by either the createTupleQuery method or by
	 * passing a Tuple class argument to the createQuery method), a Tuple object
	 * corresponding to the arguments of the multiselect method, in the
	 * specified order, will be instantiated and returned for each row that
	 * results from the query execution.
	 * 
	 * If the type of the criteria query is CriteriaQuery<X> for some
	 * user-defined class X (i.e., a criteria query object created by passing a
	 * X class argument to the createQuery method), the arguments to the
	 * multiselect method will be passed to the X constructor and an instance of
	 * type X will be returned for each row.
	 * 
	 ...
	 * the array will correspond to the arguments of the multiselect method, in
	 * the specified order.
	 * 
	 * If the type of the criteria query is CriteriaQuery<Object> or if the
	 * criteria query was created without specifying a type, and only a single
	 * argument is passed to the multiselect method, an instance of type Object
	 * will be returned for each row.
	 * 
	 * If the type of the criteria query is CriteriaQuery<Object> or if the
	 * criteria query was created without specifying a type, and more than one
	 * argument is passed to the multiselect method, an instance of type
	 * Object[] will be instantiated and returned for each row. The elements of
	 * the array will correspond to the arguments to the multiselect method, in
	 * the specified order.
	 * 
	 * @param selections
	 ...
	 * The type of the result of the query execution depends on the
	 * specification of the type of the criteria query object created as well as
	 * the argument to the multiselect method. An element of the list passed to
	 * the multiselect method must not be a tuple- or array-valued compound
	 * selection item.
	 * 
	 * The semantics of this method are as follows:
	 * 
	 ...
	 * criteria query object created by either the createTupleQuery method or by
	 * passing a Tuple class argument to the createQuery method), a Tuple object
	 * corresponding to the elements of the list passed to the multiselect
	 * method, in the specified order, will be instantiated and returned for
	 * each row that results from the query execution.
	 * 
	 * If the type of the criteria query is CriteriaQuery<X> for some
	 * user-defined class X (i.e., a criteria query object created by passing a
	 * X class argument to the createQuery method), the elements of the list
	 * passed to the multiselect method will be passed to the X constructor and
	 * an instance of type X will be returned for each row.
	 * 
	 * If the type of the criteria query is CriteriaQuery<X[]> for some class X,
	 * an instance of type X[] will be returned for each row. The elements of
	 * the array will correspond to the elements of the list passed to the
	 * multiselect method, in the specified order.
	 * 
	 * If the type of the criteria query is CriteriaQuery<Object> or if the
	 * criteria query was created without specifying a type, and the list passed
	 * to the multiselect method contains only a single element, an instance of
	 * type Object will be returned for each row.
	 * 
	 * If the type of the criteria query is CriteriaQuery<Object> or if the
	 * criteria query was created without specifying a type, and the list passed
	 * to the multiselect method contains more than one element, an instance of
	 * type Object[] will be instantiated and returned for each row. The
	 * elements of the array will correspond to the elements of the list passed
	 * to the multiselect method, in the specified order.
	 * 
	 * @param selectionList
