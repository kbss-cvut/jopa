...
import cz.cvut.kbss.owlpersistence.model.query.Tuple;

/**
 * Used to construct criteria queries, compound selections, expressions,
 * predicates, orderings. Note that Predicate is used instead of
 * Expression<Boolean> in this API in order to work around the fact that Java
...
public interface CriteriaBuilder {
	...
	/**
	 * Create a CriteriaQuery object with the specified result type. @param
	 * resultClass type of the query result @return criteria query object
	 **/
	<T> CriteriaQuery<T> createQuery(Class<T> resultClass);

	/**
	 * Create a CriteriaQuery object that returns a tuple of objects as its
	 * result.
	 * 
	 * @return criteria query object
	 */
	 ...
	 * equivalent to an any expression.
	 * 
	 * @param subquery
	 ...
	 * equivalent to a some expression.
	 * 
	 * @param subquery
	 ...
	 */
	<Y extends Comparable<? super Y>> Predicate greaterThan(
	 ...
	 */
	<Y extends Comparable<? super Y>> Predicate greaterThanOrEqualTo(
			Expression<? extends Y> x, Expression<? extends Y> y);
	 ...
	 */
	<Y extends Comparable<? super Y>> Predicate lessThan(
			Expression<? extends Y> x, Expression<? extends Y> y);
	 ...
	 */
	<Y extends Comparable<? super Y>> Predicate lessThanOrEqualTo(
			Expression<? extends Y> x, Expression<? extends Y> y);
	 ...
	 */
	<Y extends Comparable<? super Y>> Predicate between(
	 ...
	 * @return size expression
	 */
	<E, C extends Collection<?>> Expression<Integer> size(C collection);

	/**
	 * <E, Create a predicate that tests whether an element is a member of a
