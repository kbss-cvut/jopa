...
public class UnitOfWorkChangeSetTest {
	...
	public void setUp() throws Exception {
		...
		this.testClone = "TEST";
		this.newChangeSet = new ObjectChangeSetImpl(testObject, testClone, true, null);
		this.changeSet = new ObjectChangeSetImpl(testObject, testClone, false, null);
	}
	...
	public void testAddObjectChangeSetWithNew() {
		...
		Map<?, ?> trans = (Map<?, ?>) chs.getNewObjectChangeSets().get(newChangeSet.getObjectClass());
