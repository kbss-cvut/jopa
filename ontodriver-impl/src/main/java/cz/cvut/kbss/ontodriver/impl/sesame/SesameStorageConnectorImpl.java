...
class SesameStorageConnectorImpl implements SesameStorageConnector {

	private static final Logger LOG = Logger.getLogger(SesameStorageConnectorImpl.class.getName());
	...
	public SesameStorageConnectorImpl(OntologyStorageProperties storageProps)
