...
public class TestUpdateOperationsMultiContextMemoryStore {

	private static final Logger LOG = Logger
			.getLogger(TestUpdateOperationsMultiContextMemoryStore.class.getName());
	...
	public void testUpdateDataPropertyInContext() throws Exception {
		em = TestEnvironment.getPersistenceConnector("SesameMultiUpdateDataPropertyInContext",
	...
	public void testUpdateObjectPropertyToDifferentContext() throws Exception {
		em = TestEnvironment.getPersistenceConnector("SesameMultiUpdateObjectPropertyToDifferent",
				storage, false, properties);
	...
	public void testUpdateAddToPropertiesInContext() throws Exception {
		em = TestEnvironment.getPersistenceConnector("SesameMultiUpdateAddToPropertiesInContext",
				storage, false, properties);
	...
	public void testUpdateAddToSimpleListInContext() throws Exception {
		em = TestEnvironment.getPersistenceConnector("SesameMultiUpdateAddToSimpleListInContext",
				storage, false, properties);
	...
	public void testUpdateAddToReferencedListInContext() throws Exception {
		em = TestEnvironment.getPersistenceConnector(
				"SesameMultiUpdateAddToReferencedListInContext", storage, false, properties);
	...
	public void testUpdateRemoveFromSimpleListInContext() throws Exception {
		em = TestEnvironment.getPersistenceConnector(
				"SesameMultiUpdateRemoveFromSimpleListInContext", storage, false, properties);
	...
	public void testUpdateRemoveFromReferencedListInContext() throws Exception {
		em = TestEnvironment.getPersistenceConnector(
				"SesameMultiUpdateRemoveFromReferencedListInContext", storage, false, properties);
