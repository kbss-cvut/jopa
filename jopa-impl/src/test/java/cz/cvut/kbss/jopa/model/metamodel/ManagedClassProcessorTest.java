...
public class ManagedClassProcessorTest {
    ...
    @Test
    public void processEntityTypeThrowsInitializationExceptionWhenClassIsMissingNoArgConstructor() {
        ...
        ManagedClassProcessor.processEntityType(ClassWithoutNoArgConstructor.class);
    }
