...
public class SesameNativeStoreQueryTests {

	private static final Logger LOG = Logger.getLogger(SesameNativeStoreQueryTests.class.getName());
	...
	public static void setUpBeforeClass() throws Exception {
		em = TestEnvironment.getPersistenceConnector("SesameNativeSPARQLQueryTests", storage,
				false, properties);
