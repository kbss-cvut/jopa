...
<node CREATED="1412766318176" FOLDED="true" ID="ID_1887107087" MODIFIED="1417769738593" TEXT="Create strategy for working with types, which will merge types received from JOPA to those in the ontology">
...
<node CREATED="1412764150384" ID="ID_1232791949" MODIFIED="1417769742880" TEXT="Add addTypes/removeTypes to OntoDriver API">
<icon BUILTIN="button_ok"/>
</node>
</node>
...
<node CREATED="1413920406619" FOLDED="true" ID="ID_239344121" MODIFIED="1417769759552" TEXT="Should we add removeSimple(Ref)List, persistSimple(Ref)List etc?">
<icon BUILTIN="button_ok"/>
...
<node CREATED="1415186005171" ID="ID_1191722711" MODIFIED="1417769748385" POSITION="right" TEXT="Load all lazily loaded fields on entity detach">
