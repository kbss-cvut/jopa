...
class Rdf4jAdapterTest {
    ...
    void constructorUsesProvidedConfiguration() throws Exception {
        ...
        final Field configField = Rdf4jAdapter.class.getDeclaredField("config");
    ...
    private Map<Assertion, Statement> initStatementsForDescriptor(AxiomDescriptor desc) {
        ...
        for (Assertion as : desc.getAssertions()) {
            final IRI property = VF.createIRI(as.getIdentifier().toString());
    ...
    void testFindEntityWithTypesAndSubjectContext() throws Exception {
        ...
        final IRI typeProperty = VF.createIRI(Assertion
    ...
    void unwrapReturnsItselfWhenClassMatches() throws Exception {
        assertSame(adapter, adapter.unwrap(Rdf4jAdapter.class));
    }
    ...
    @Test
    void getTypesHandlerStartsTransaction() throws Rdf4jDriverException {
        adapter.getTypesHandler();
        verify(connectorMock).begin();
    }

    @Test
    void getSimpleListHandlerStartsTransaction() throws Rdf4jDriverException {
